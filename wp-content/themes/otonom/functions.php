...
function html5blank_styles()
{
    if (HTML5_DEBUG) {
        ...
        // Custom CSS
        wp_register_style('html5blank', get_template_directory_uri() . '/dest/style.css', array(), '1.0');
        // Register CSS
        wp_enqueue_style('html5blank');
    } else {
        // Custom CSS
        wp_register_style('html5blankcssmin', get_template_directory_uri() . '/dest/style.css', array(), '1.0');
        // Register CSS
